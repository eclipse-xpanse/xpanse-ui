...
export class ServiceVendorApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async detail(id: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/xpanse/services/register/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
    ...
    public async fetch(oclLocation: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/xpanse/services/register/file';
    ...
    public async fetchUpdate(id: string, oclLocation: string, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/xpanse/services/register/file/{id}'.replace(
            '{' + 'id' + '}',
    ...
    public async listCategories(_options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/xpanse/services/categories';
    ...
    public async listRegisteredServices(
        ...
        // Path Params
        const localVarPath = '/xpanse/services/register';
...
export class ServiceVendorApiResponseProcessor {
    ...
    public async listRegisteredServices(response: ResponseContext): Promise<Array<RegisteredServiceVo>> {
        ...
        if (isCodeInRange('200', response.httpStatusCode)) {
            const body: Array<RegisteredServiceVo> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                'Array<RegisteredServiceVo>',
                ''
            ) as Array<RegisteredServiceVo>;
            return body;
        }
