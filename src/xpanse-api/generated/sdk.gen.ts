...
/**
 * Process the execution result of the order task from terra-boot.
 * @param data The data for the request.
 * @param data.orderId Id of the order.
 * @param data.requestBody
 * @returns unknown OK
 * @throws ApiError
 */
export const orderCallback = (data: OrderCallbackData): CancelablePromise<OrderCallbackResponse> => {
    return __request(OpenAPI, {
        method: 'POST',
        url: '/webhook/terra-boot/order/{orderId}',
        path: {
