 ...
 * The cloud service provider of the credential.
 */
export type csp = 'huawei' | 'flexibleEngine' | 'openstack' | 'scs' | 'alicloud' | 'aws' | 'azure' | 'google';

/**
 * The type of the credential
 */
export type type = 'variables' | 'http_authentication' | 'api_key' | 'oauth2';
 ...
 *  This is used only for display purposes. When provided, this billingMode will be selected in the frontends by default.
 */
export type defaultBillingMode = 'Fixed' | 'Pay per Use';
...
export type CloudServiceProvider = {
     ...
     */
    name: 'huawei' | 'flexibleEngine' | 'openstack' | 'scs' | 'alicloud' | 'aws' | 'azure' | 'google';
    /**
 ...
 * The Cloud Service Provider.
 */
export type name = 'huawei' | 'flexibleEngine' | 'openstack' | 'scs' | 'alicloud' | 'aws' | 'azure' | 'google';
 ...
 * The type of the Deployer which will handle the service deployment
 */
export type kind = 'terraform' | 'opentofu';

/**
 * The credential type to do the deployment
 */
export type credentialType = 'variables' | 'http_authentication' | 'api_key' | 'oauth2';
 ...
 * Defines which cloud service account is used for deploying cloud resources.
 */
export type serviceHostingType = 'self' | 'service-vendor';
 ...
 * The period of the cost.
 */
export type period = 'yearly' | 'monthly' | 'daily' | 'hourly' | 'oneTime';
 ...
 * State of registered service template.
 */
export type serviceRegistrationState = 'unregistered' | 'approval pending' | 'approved' | 'rejected';
 ...
 * The billing mode of the managed service.
 */
export type billingMode = 'Fixed' | 'Pay per Use';
 ...
 * The status of the Task
 */
export type status = 'done' | 'failed';
 ...
 * The deployment state of the service
 */
export type serviceDeploymentState =
    | 'deploying'
    | 'deployment successful'
    | 'deployment failed'
    | 'destroying'
 ...
 * The run state of the service
 */
export type serviceState = 'not running' | 'running' | 'starting' | 'stopping' | 'stopped' | 'restarting';
 ...
 * The status of the service state management task.
 */
export type taskStatus = 'created' | 'in progress' | 'successful' | 'failed';
 ...
 * The type of the service state management task.
 */
export type taskType = 'start' | 'stop' | 'restart';
 ...
 * The type of the metric.
 */
export type type2 = 'counter' | 'gauge' | 'histogram' | 'summary';

/**
 * The resource type of the metric.
 */
export type monitorResourceType = 'cpu' | 'mem' | 'vm_network_incoming' | 'vm_network_outgoing';

/**
 * The unit of the metric.
 */
export type unit = 'mb' | 'kb' | 'percentage' | 'bit/s' | 'Byte/s';
 ...
 * Type of the MetricItem.
 */
export type type3 = 'value' | 'count' | 'sum';
 ...
 * The health status of backend system.
 */
export type healthStatus = 'OK' | 'NOK';
...
export type GetActiveCspsResponse = Array<
    'huawei' | 'flexibleEngine' | 'openstack' | 'scs' | 'alicloud' | 'aws' | 'azure' | 'google'
>;
    ...
    '/xpanse/csps/active': {
        get: {
            res: {
                 ...
                 * OK
                 */
                200: Array<'huawei' | 'flexibleEngine' | 'openstack' | 'scs' | 'alicloud' | 'aws' | 'azure' | 'google'>;
                /**
                 * Bad Request
                 */
                400: Response;
