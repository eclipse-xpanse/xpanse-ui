...
export function getRolesOfUser(oidcUserInfo: object): string[] {
    if ('urn:zitadel:iam:org:project:roles' in oidcUserInfo) {
        if (
            ...
            const lastSelectedRole: string | null = sessionStorage.getItem(userRoleKey);
            const availableRolesToUser: string[] = Object.keys(oidcUserInfo['urn:zitadel:iam:org:project:roles']);
