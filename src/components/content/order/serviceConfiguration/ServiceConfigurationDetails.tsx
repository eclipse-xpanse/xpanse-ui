...
import { Button, Empty, Form, Input, Popconfirm, Row } from 'antd';
...
export const ServiceConfigurationDetails = ({
    ...
    return (
        <>
            {userOrderableServiceVo && getCurrentConfigurationOfServiceQuery.data ? (
                    ...
                    >
                        <div className={serviceOrderStyles.orderParamItemRow}>
                            <div className={serviceOrderStyles.orderParamItemContent}>
                                ...
                                >
                                    <Input
                                        value={getCurrentConfigurationOfServiceQuery.data.updatedTime}
                                        disabled={true}
                                    />
                                </Form.Item>
                            </div>
                            ...
                            Object.entries(getCurrentConfigurationOfServiceQuery.data.configuration).map(([key]) => (
                                <div key={key}>
                                    <ServiceConfigParameterItem
                                        actionParameter={userOrderableServiceVo.configurationParameters?.find(
