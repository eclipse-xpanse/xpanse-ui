...
export function ContactDetailsText({
    ...
    const filterNullProperties = (contactDetails: ServiceProviderContactDetails): ServiceProviderContactDetails => {
        // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
        return Object.fromEntries(Object.entries(contactDetails).filter(([_, value]) => value !== null));
    };
    ...
    if (serviceProviderContactDetails) {
        ...
        // @ts-expect-error
        yamlDocument.contents = filterNullProperties(serviceProviderContactDetails);
        return (
